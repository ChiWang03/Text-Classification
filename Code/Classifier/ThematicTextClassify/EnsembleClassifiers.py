...
# Scoring function for stacking and voting models 
# This method iterates through all the classifiers as well as the ensemble classifier to print out cross validated accuracy scores
